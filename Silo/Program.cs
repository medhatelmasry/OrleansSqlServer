...
public class Program
{
    ...
    private const string ConnectionString = @"Data Source=localhost,1444;Database=NewOrleans;Persist Security Info=True;User ID=sa;Password=SqlPassword!;TrustServerCertificate=True;";
